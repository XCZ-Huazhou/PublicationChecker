...
(function () {
  ...
  function ensureDom() {
    ...
    style.textContent = [
      ...
      ".if-pill{display:inline-block;margin-left:8px;padding:2px 8px;border-radius:999px;background:#2d5ac8;color:#fff;font-size:11px;font-weight:700;vertical-align:middle;}",
